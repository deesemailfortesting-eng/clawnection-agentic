...
export default function ReviewProfilePage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setSaving(true);
    saveProfile(profile);
    const synced = await syncProfileToServer(profile);
    setSaving(false);
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="space-y-3">
          ...
          <p className="max-w-2xl text-sm leading-6 text-zinc-600">
            We pulled this from your voice conversation. Review everything below
            and fix anything that doesn't look accurate before continuing.
          </p>
        </header>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <OnboardingSection
            title="Core profile"
            description="Essentials used for introductions and baseline matching."
          >
          ...
          <OnboardingSection
            ...
            description="Signals that influence practical compatibility."
          >
            <div className="grid gap-4 sm:grid-cols-2">
              {(
                [
          ...
          <OnboardingSection
            title="Match preferences & agent mode"
            description="Set your counterpart preferences and choose your personal agent path."
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="text-sm text-zinc-700">
                Preferred min age
              ...
              <fieldset className="sm:col-span-2 rounded-xl border border-zinc-200 p-3">
                <legend className="px-2 text-sm font-medium text-zinc-800">
                  Agent type
                </legend>
          ...
          >
            {saving ? "Saving..." : "Looks Good — Continue to Demo"}
          </button>
        </form>
      </div>
    </main>
